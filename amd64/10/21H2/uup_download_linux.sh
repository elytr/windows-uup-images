#!/bin/bash
#Generated on 2022-04-30 14:39:45 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=574b114f-3727-4a41-8325-755ea6b6f49d&pack=en-us&edition=core;professional&aria2=2"
if [ $? != 0 ]; then
