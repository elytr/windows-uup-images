#!/bin/bash
#Generated on 2022-04-30 14:30:49 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=3882dff7-dd42-49c4-a51d-ce45db4dc37c&pack=en-us&edition=core;professional&aria2=2"
if [ $? != 0 ]; then
