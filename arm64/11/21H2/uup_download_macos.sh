#!/bin/bash
#Generated on 2022-04-30 14:48:58 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=cb32ccb8-49b7-476f-b389-2993030d609d&pack=en-us&edition=core;professional&aria2=2"
if [ $? != 0 ]; then
