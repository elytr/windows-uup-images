#!/bin/bash
#Generated on 2022-04-30 14:46:08 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=2ef43ac6-9945-4f48-b47d-9356d8abf551&pack=en-us&edition=core;professional&aria2=2"
if [ $? != 0 ]; then
